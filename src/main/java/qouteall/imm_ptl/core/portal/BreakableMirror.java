...
public class BreakableMirror extends Mirror {
    ...
    public static BreakableMirror createMirror(
        ...
        BreakableMirror breakableMirror = BreakableMirror.ENTITY_TYPE.create(world, EntitySpawnReason.EVENT);
    ...
    private static void breakIntersectedMirror(BreakableMirror newMirror) {
        McHelper.getEntitiesNearby(
            ...
            mirror1 -> mirror1.getUnitVec3i().dot(newMirror.getUnitVec3i()) > 0.5
        ).filter(

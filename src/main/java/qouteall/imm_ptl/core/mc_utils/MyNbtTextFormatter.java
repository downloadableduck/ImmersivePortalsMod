...
public class MyNbtTextFormatter
    ...
    public void visitString(StringTag element) {
        String string = StringTag.quoteAndEscape(element.asString().get());
    ...
    public void visitByte(ByteTag element) {
        ...
        this.result = Component.literal(String.valueOf(element.asNumber().get())).append(text).withStyle(NUMBER_COLOR);
    }
    ...
    public void visitInt(IntTag element) {
        this.result = Component.literal(String.valueOf(element.asNumber().get())).withStyle(NUMBER_COLOR);
    }
    ...
    public void visitFloat(FloatTag element) {
        ...
        this.result = Component.literal(String.valueOf(element.asFloat().get())).append(text).withStyle(NUMBER_COLOR);
    }
    
    @Override
    public void visitDouble(DoubleTag element) {
        MutableComponent text = Component.literal("d").withStyle(TYPE_SUFFIX_COLOR);
        this.result = Component.literal(String.valueOf(element.asDouble().get())).append(text).withStyle(NUMBER_COLOR);
    }
    ...
    public void visitList(ListTag element) {
        ...
        if (SINGLE_LINE_ELEMENT_TYPES.contains(element.getType()) && element.size() <= 8) {

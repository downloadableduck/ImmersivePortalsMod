...
public class LoadingIndicatorRenderer extends EntityRenderer<LoadingIndicatorEntity, LivingEntityRenderState> {
    ...
    public void render(
        LivingEntityRenderState state, PoseStack poseStack, MultiBufferSource bufferSource, int i
    ) {
